...
import 'package:dmt_movie_flutter/src/screens/profile_management_screen.dart';
...
class AppRoutes {
  ...
  static const String defaultRoute = profileManagement;
  ...
  static Map<String, WidgetBuilder> map = {
    ...
    profileManagement: (_) => const ProfileManagementScreen(),
